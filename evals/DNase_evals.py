...
targets_flat = torch.zeros(len(ccre))
...
#now save it out
torch.save(targets, '/data/leslie/sarthak/hyena/hyena-dna/outputs/2024-02-09/17-38-16-568113/checkpoints/targets.pt')
torch.save(predicts, '/data/leslie/sarthak/hyena/hyena-dna/outputs/2024-02-09/17-38-16-568113/checkpoints/predicts.pt')
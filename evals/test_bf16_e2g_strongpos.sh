...
pixi run python -u test_bf16_e2g.py \
    --n_elements 30 --rows_npy /data1/lesliec/sarthak/data/joint_playground/e2g/bf16_strongpos_rows.npy \
    --save_npz /data1/lesliec/sarthak/data/joint_playground/e2g/bf16_strongpos.npz

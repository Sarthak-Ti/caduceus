...
#SBATCH --time=4:00:00
#SBATCH --mem=64G
#SBATCH --job-name=borzoi_cage_avg
#SBATCH --output=/data1/lesliec/sarthak/caduceus/jobs/%j-%x.out

# Cross-cell-type CAGE average over borzoi fold3, strand-separate.
#   -> /data1/lesliec/sarthak/data/borzoi/borzoi_fold3_CAGE_avg.npz
#
...
pixi run python -u evals/borzoi_cage_avg.py -j "${SLURM_CPUS_PER_TASK:-16}" "$@"

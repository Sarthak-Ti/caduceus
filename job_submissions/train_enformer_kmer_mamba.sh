...
python -m train wandb.group=enformer wandb.name=enformer_kmer_mamba_cage_2 experiment=hg38/enformer dataset.batch_size=1 \
 ...
 dataset.return_CAGE=true dataset.d_output=5313 trainer.accumulate_grad_batches=8 \
 train.ckpt=/data/leslie/sarthak/caduceus/outputs/2024-09-03/12-09-37-103637/checkpoints/last.ckpt \

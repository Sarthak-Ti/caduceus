...
python -m train wandb.group=enformer wandb.name=enformer_linear_3 experiment=hg38/enformer dataset.batch_size=2 \
 trainer.precision=bf16 dataset.num_workers=4

...
python -m train wandb.group=enformer wandb.name=enformer_linear_mamba_3 experiment=hg38/enformer dataset.batch_size=2 \
 ...
 train.pretrained_model_path=null +dataset.cell_type=121 \

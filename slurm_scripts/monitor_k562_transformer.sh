...
#SBATCH --mem=1G
#SBATCH --job-name=monitor_k562_transformer
#SBATCH --output=/data1/lesliec/sarthak/caduceus/jobs/%j-monitor_k562_transformer.out

source ~/.bashrc

JOB_NAME="finetune_k562plus10_transformer"
CADUCEUS_DIR="/data1/lesliec/sarthak/caduceus"
JOBS_DIR="$CADUCEUS_DIR/jobs"
SLURM_SCRIPT="$CADUCEUS_DIR/slurm_scripts/finetune_joint_k562_many_transformer.sh"
STATE_FILE="$CADUCEUS_DIR/slurm_scripts/.monitor_k562_transformer_state"
LOG_FILE="$CADUCEUS_DIR/slurm_scripts/monitor_k562_transformer.log"
BASE_SEED=2222

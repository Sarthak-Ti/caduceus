...
#SBATCH --job-name=joint_cont_sepcnn_combined_k562_finetune_CAGE_RNA
...
pixi run srun python -m train wandb.group=joint_pretrain wandb.name=$SLURM_JOB_NAME experiment=hg38/joint_finetune dataset.batch_size=1 \
 ...
 \
 +decoder.conjoin_train=false +decoder.conjoin_test=false +decoder.convolutions=true +decoder.bin_size=32 +decoder.yshape=196608 \
 +decoder.d_model=256 +decoder.d_output=4 +dataset.additional_data=/data1/lesliec/sarthak/data/borzoi/borzoi.zarr \
 +dataset.additional_data_idxs=/data1/lesliec/sarthak/data/DK_zarr/idx_lists/k562_CAGE_RNA.json \
 train.pretrained_model_path="/data1/lesliec/sarthak/caduceus/outputs/2025-07-18/00-23-52-538795/checkpoints/last.ckpt"
#  train.ckpt="/data1/lesliec/sarthak/caduceus/outputs/2025-08-10/22-42-38-598048/checkpoints/last.ckpt" +train.pretrained_model_state_hook.load_decoder=true \
...
#  \
#  +decoder.conjoin_train=false +decoder.conjoin_test=false +decoder.convolutions=true +decoder.bin_size=32 +decoder.yshape=196608 \
#  +decoder.d_model=256 +decoder.d_output=2 +dataset.additional_data=/data1/lesliec/sarthak/data/borzoi/borzoi.zarr \
#  +dataset.additional_data_idxs=/data1/lesliec/sarthak/data/DK_zarr/idx_lists/k562_CAGE.json \
#  train.pretrained_model_path="/data1/lesliec/sarthak/caduceus/outputs/2025-07-18/00-23-52-538795/checkpoints/last.ckpt"
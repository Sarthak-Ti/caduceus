...
#SBATCH --job-name=joint_k562plus10_transformer_maskonly
...
#  encoder.joint=true +encoder.d_model=128 +encoder.transpose=true +encoder.norm=null +encoder.activation=null +encoder.ctt=true +encoder.celltypes=10 \
#  \
#  +callbacks=model_every_n_steps callbacks.model_checkpoint_every_n_steps.every_n_train_steps=2000 trainer.accumulate_grad_batches=1